  ...
  <div>
    <div class="boxes">
      ...
      <div class="box">
        <span>10</span
        ><img
          src="https://i.scdn.co/image/ab67706c0000bebb30677d72001e25584b0fbb37"
        />
      </div>
      <div class="controls">
        <button class="next">
...
//   transform: translate(-50%, -50%) rotate(180deg) translate(0, -100%)
//     translate(0, -0.5vmin) scale(1.01);
//   z-index: 2;
// }
// .box img {
//   position: absolute;
...
//   .box {
//     -webkit-box-reflect: below 0.5vmin
//       linear-gradient(transparent 0 50%, #fff 100%);
//   }
//   .box:after,
//   .box:before {
//     display: none;
